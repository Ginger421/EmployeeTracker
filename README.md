...
## Description
This application was designed to allow users to manage database by viewing, adding and updating departments, roles and employees. This application was created using JavaScript, cTable, mysql and inquirer.
